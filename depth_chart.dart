...
class DepthChart extends StatefulWidget {
  ...
  @override
  State createState() => _DepthChartState();
}
...
class DepthChartPainter extends CustomPainter {
  ...
  DepthChartPainter(
      this.mBuyData, this.mSellData, this.pressOffset, this.isLongPress, this.fixedLength, this.mBuyPathColor, this.mSellPathColor, this.chartColors) {
    mBuyLinePaint ??= Paint()
      ..isAntiAlias = true
  ...
  getTextPainter(String text) =>
      TextPainter(text: TextSpan(text: "${formatWithComma(text,-1)}", style: TextStyle(color: chartColors.defaultTextColor, fontSize: 10)), textDirection: TextDirection.ltr);
